...
public class ShapedTailorRecipes implements ITailorRecipe {
	...
	public ShapedTailorRecipes(int wdth, int heit, ItemStack[] inputs, ItemStack output, int tier, int stitches,
			float time, int string) {
	...
	public ItemStack getCraftingResult(InventoryCrafting matrix) {
		ItemStack out = new ItemStack(this.recipeOutput.itemID, this.recipeOutput.stackSize, this.recipeOutput.getItemDamage());
		if (this.recipeOutput.hasTagCompound()) {
			out.stackTagCompound = this.recipeOutput.getTagCompound();
		}
