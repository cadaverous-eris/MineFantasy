...
{
	public static HashMap<List<Integer>, Integer> stringList = new HashMap<List<Integer>, Integer>();
	public static HashMap<Integer, Integer>  stringID = new HashMap<Integer, Integer>();
