...
public class ShapelessAnvilRecipes implements IAnvilRecipe {
	...
	public ShapelessAnvilRecipes(ItemStack output, float exp, int hammer, int anvi, int time, List components,
			boolean hot) {
		this.outputHot = hot;
			...
			for (int var4 = 0; var4 <= AnvilProps.globalHeight; ++var4) {
				...
				if (inputItem != null) {
					...
					while (var7.hasNext()) {
						...
						if (inputItem.itemID == recipeItem.itemID
	...
	public List getIngredients() {
		return new ArrayList(this.recipeItems);
	}
