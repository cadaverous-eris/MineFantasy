...
public class ShapedAnvilRecipes implements IAnvilRecipe
{
    ...
    {
    	ItemStack stack = new ItemStack(this.recipeOutput.itemID, this.recipeOutput.stackSize, this.recipeOutput.getItemDamage());
        if (this.recipeOutput.hasTagCompound()) {
        	stack.stackTagCompound = this.recipeOutput.getTagCompound();
        }
    	return stack;
    }
