...
public class SpecialFurnaceRecipes {
	...
	public static HashMap<Integer, SpecialSmelt> specials = new HashMap<Integer, SpecialSmelt>();
	public static HashMap<List<Integer>, SpecialSmelt> specialsMeta = new HashMap<List<Integer>, SpecialSmelt>();
	...
	public static class SpecialSmelt
	{
		public int lvl;
		public ItemStack result;
		public SpecialSmelt(int level, ItemStack out)
		{
			lvl = level;
			result = out;
		}
