...
public class LeathercuttingRecipes
{
    ...
    public Map<Integer, ItemStack> tanningList = new HashMap<Integer, ItemStack>();
    public Map experienceList = new HashMap();
    public Map<List<Integer>, ItemStack> metaTanningList = new HashMap<List<Integer>, ItemStack>();
