...
public class ComponentVillageMFHovel2 extends ComponentVillageMF {

	public ComponentVillageMFHovel2() {
	}

	public ComponentVillageMFHovel2(ComponentVillageMFStartPiece par1ComponentVillageStartPiece, int par2,
	...
	public static ComponentVillageMFHovel2 create(ComponentVillageMFStartPiece par0ComponentVillageStartPiece,
		...
		return canVillageGoDeeper(structureboundingbox)
				&& StructureComponent.findIntersecting(par1List, structureboundingbox) == null
						? new ComponentVillageMFHovel2(par0ComponentVillageStartPiece, par7, par2Random,
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox structureboundingbox) {
        ...
        this.fillWithBlocks(world, structureboundingbox, 2, 1, 1, 4, 4, 1, BlockListMF.clayWall.blockID, BlockListMF.clayWall.blockID, false);
        this.fillWithBlocks(world, structureboundingbox, 2, 1, 5, 4, 4, 5, BlockListMF.clayWall.blockID, BlockListMF.clayWall.blockID, false);
        this.fillWithBlocks(world, structureboundingbox, 1, 1, 2, 1, 3, 4, BlockListMF.clayWall.blockID, BlockListMF.clayWall.blockID, false);
        this.fillWithBlocks(world, structureboundingbox, 5, 1, 2, 5, 3, 4, BlockListMF.clayWall.blockID, BlockListMF.clayWall.blockID, false);
        this.placeBlockAtCurrentPosition(world, BlockListMF.clayWall.blockID, 0, 3, 5, 1, structureboundingbox);
        this.placeBlockAtCurrentPosition(world, BlockListMF.clayWall.blockID, 0, 3, 5, 5, structureboundingbox);
        this.fillWithBlocks(world, structureboundingbox, 3, 5, 2, 3, 5, 4, Block.planks.blockID, Block.planks.blockID, false);
