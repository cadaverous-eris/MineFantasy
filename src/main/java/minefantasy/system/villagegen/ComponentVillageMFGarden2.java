...
public class ComponentVillageMFGarden2 extends ComponentVillageMF {

	public ComponentVillageMFGarden2() {
	}

	public ComponentVillageMFGarden2(ComponentVillageMFStartPiece par1ComponentVillageStartPiece, int par2,
	...
	public static ComponentVillageMFGarden2 create(ComponentVillageMFStartPiece par0ComponentVillageStartPiece,
		...
		return canVillageGoDeeper(structureboundingbox)
				&& StructureComponent.findIntersecting(par1List, structureboundingbox) == null
						? new ComponentVillageMFGarden2(par0ComponentVillageStartPiece, par7, par2Random,
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox structureboundingbox) {
		...
		key.put("crop", new int[] {Block.potato.blockID, 7});
