...
public class ComponentVillageMFGarden3 extends ComponentVillageMF {

	public ComponentVillageMFGarden3() {
	}

	public ComponentVillageMFGarden3(ComponentVillageMFStartPiece par1ComponentVillageStartPiece, int par2,
	...
	public static ComponentVillageMFGarden3 create(ComponentVillageMFStartPiece par0ComponentVillageStartPiece,
		...
		return canVillageGoDeeper(structureboundingbox)
				&& StructureComponent.findIntersecting(par1List, structureboundingbox) == null
						? new ComponentVillageMFGarden3(par0ComponentVillageStartPiece, par7, par2Random,
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox structureboundingbox) {
		...
		key.put("flower_1", new int[] {Block.plantRed.blockID});
		key.put("flower_2", new int[] {Block.plantYellow.blockID, 7});
		
		this.fillWithBlocks(world, structureboundingbox, 0, 0, 0, 6, 1, 5, 0, 0, false);
	...
	private static String[][][] blueprint = new String[][][] {
		...
		},
		{
			...
			{ "", "fence", "flower_1", "flower_1", "flower_1", "fence", "" },
			{ "", "fence", "flower_2", "flower_2", "flower_2", "fence", "" },
			{ "", "fence", "fence", "fence", "fence", "fence", "" },
			{ "", "", "", "", "", "", "", "" }
		}
	};
