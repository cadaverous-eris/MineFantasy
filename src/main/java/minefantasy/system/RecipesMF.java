...
public class RecipesMF {
	...
	public static void initiate() {
    	...
    	FurnaceRecipes.smelting().addSmelting(BlockListMF.oreUtil.blockID, 0, new ItemStack(ItemListMF.ingotSilver), 1.0F);
        ...
        GameRegistry.addRecipe(new ItemStack(BlockListMF.woodSingleSlab, 6, 1), new Object[]{
            "HHH",
            'H', new ItemStack(BlockListMF.planks, 1, 1),
        });
        ...
        GameRegistry.addRecipe(new ItemStack(BlockListMF.stoneSingleSlab, 6, 2), new Object[]{
            "HHH",
            'H', new ItemStack(BlockListMF.graniteBrick, 1, 0),
        });
        GameRegistry.addRecipe(new ItemStack(BlockListMF.stoneSingleSlab, 2, 3), new Object[]{
            "H",
        	"H",
            'H', new ItemStack(Block.stoneSingleSlab, 1, 0),
        });
        ...
        GameRegistry.addRecipe(new ItemStack(BlockListMF.stoneSingleSlab2, 6, 0), new Object[]{
            "HHH",
        ...
        GameRegistry.addRecipe(new ItemStack(BlockListMF.polishedStone, 6, 2), new Object[]{
            "SS",
            "SS",
            "SS",
        ...
        GameRegistry.addRecipe(new ItemStack(BlockListMF.shingles, 3), new Object[]{
            "B B",
            "BBB",
            " B ",
            'B', new ItemStack(Item.brick, 1, 0),});
        GameRegistry.addRecipe(new ItemStack(BlockListMF.shingles, 8), new Object[]{
            "CC",
            "CC",
	...
	private static void addLeatherRecipes()
	{
    	...
    	TanningRecipes.instance().addTanning(ItemListMF.misc.itemID, ItemListMF.hidePig, com(ItemListMF.leatherRaw, 2));
	...
	private static void addHeatables()
	{
		...
		MineFantasyAPI.addHeatableItem(com(ItemListMF.lumpDeepIron), 1150, 2000, 2700);
		MineFantasyAPI.addHeatableItem(com(ItemListMF.lumpMithril), 1250, 2800, 3200);
		...
		addHeatable("ingotMithril", 1300, 3200, 3500);
	}
