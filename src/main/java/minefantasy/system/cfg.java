...
public class cfg {
    ...
    public static int Sslab2Id;
    public static int SdSlab2Id;
    ...
    //public static int dragonSpawnrateMonster;
    ...
    public void setConfig(Configuration configuration)
    {
        ...
        Sslab2Id = Integer.parseInt(this.get("Single Stone Slab 2", Configuration.CATEGORY_BLOCK, 247).getString());
        SdSlab2Id = Integer.parseInt(this.get("Double Stone Slab 2", Configuration.CATEGORY_BLOCK, 248).getString());
        ...
        minotaurSpawnrate = Integer.parseInt(this.get("Minotaur Spawn Rate", this.CATEGORY_MOBS, 4).getString());
        ...
        //dragonSpawnrateMonster = Integer.parseInt(this.get("Small Dragon Overworld Hostile Spawn Rate", this.CATEGORY_MOBS, 2).getString());
        ...
        dragonChance = Integer.parseInt(this.get("(1 in X)Small Dragon Spawn Chance", this.CATEGORY_MOBS, 16000).getString());
