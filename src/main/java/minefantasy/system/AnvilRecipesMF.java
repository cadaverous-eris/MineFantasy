...
public class AnvilRecipesMF {
	...
	private static void addTools()
	{
		...
		if(bg())
		{
			...
			addBuckler(com(ItemListMF.ingotIgnotumite), new ItemStack(ItemListMF.bucklerIgnotumite), 1, 3, ignotumiteTime);
			...
			addKite(2, com(ItemListMF.ingotIgnotumite), new ItemStack(ItemListMF.kiteIgnotumite), 1, 3, ignotumiteTime);
			...
			addTower(2, com(ItemListMF.ingotIgnotumite), new ItemStack(ItemListMF.towerIgnotumite), 1, 3, ignotumiteTime);
	...
	private static void addMisc()
	{
		...
		MineFantasyAPI.addShapelessAnvilRecipe(new ItemStack(ItemListMF.ingotSteel), false, 0, 0, 400, new Object[] {
