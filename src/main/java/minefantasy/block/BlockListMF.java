...
public class BlockListMF 
{
    ...
    public static final BlockHalfSlab stoneDoubleSlab2 = (BlockHalfSlab)(new BlockStoneSlab2MF(cfg.Sslab2Id, true)).setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("stoneSlab2");
    public static final BlockHalfSlab stoneSingleSlab2 = (BlockHalfSlab)(new BlockStoneSlab2MF(cfg.SdSlab2Id, false)).setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("stoneSlab2");
    ...
    public static void init()
    {
        ...
        MinecraftForge.setBlockHarvestLevel(forge, 2, "pickaxe", 3);
    ...
    static
    {
        ...
        Item.itemsList[stoneSingleSlab2.blockID] = (new ItemStoneSlab2MF(stoneSingleSlab2.blockID - 256, stoneSingleSlab2, stoneDoubleSlab2, false)).setUnlocalizedName("stoneSlab2");
        Item.itemsList[stoneDoubleSlab2.blockID] = (new ItemStoneSlab2MF(stoneDoubleSlab2.blockID - 256, stoneSingleSlab2, stoneDoubleSlab2, true)).setUnlocalizedName("stoneSlab2");
