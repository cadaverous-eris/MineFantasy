...
public class ItemListMF 
{
    ...
    public static final Item bucklerIgnotumite = (new ItemShield(itemId + 628, ToolMaterialMedieval.IGNOTUMITE, EnumShieldDesign.BUCKLER));
    public static final Item kiteIgnotumite = (new ItemShield(itemId + 629, ToolMaterialMedieval.IGNOTUMITE, EnumShieldDesign.KITE));
    public static final Item towerIgnotumite = (new ItemShield(itemId + 630, ToolMaterialMedieval.IGNOTUMITE, EnumShieldDesign.TOWER));
   ...
   // public static final int linen = 93;
	...
	private static void addChestGen()
	{
		...
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(Item.bread), 1, 4, 15));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(ItemListMF.miscFood.itemID, 1, 0), 3, 7, 25));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(ItemListMF.miscFood.itemID, 1, 7), 1, 1, 2));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(ItemListMF.miscFood.itemID, 1, 8), 1, 1, 2));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(ItemListMF.miscFood.itemID, 1, 9), 1, 1, 2));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(ItemListMF.miscFood.itemID, 1, 10), 1, 1, 2));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(ItemListMF.miscFood.itemID, 1, 27), 1, 1, 2));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(Item.pumpkinPie), 1, 1, 1));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(Item.wheat), 3, 5, 25));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(new ItemStack(Item.egg), 1, 3, 10));
		ChestGenHooks.addItem(BAKERY_CHEST, new WeightedRandomChestContent(component(salt), 2, 4, 5));
		ChestGenHooks.getInfo(BAKERY_CHEST).setMin(3);
		ChestGenHooks.getInfo(BAKERY_CHEST).setMin(6);
		
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(Item.porkRaw), 1, 3, 15));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(Item.beefRaw), 1, 3, 5));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(Item.chickenRaw), 1, 3, 10));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(muttonRaw), 1, 3, 10));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(miscFood, 1, 1), 2, 4, 10));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(miscFood, 1, 3), 2, 4, 10));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(miscFood, 1, 5), 2, 4, 10));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(miscFood, 1, 25), 2, 4, 10));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(component(tendon), 4, 9, 20));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(Item.rottenFlesh), 12, 23, 30));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(new ItemStack(Item.bone), 4, 9, 25));
		ChestGenHooks.addItem(BUTCHER_CHEST, new WeightedRandomChestContent(component(salt), 3, 7, 15));
		ChestGenHooks.getInfo(BUTCHER_CHEST).setMin(3);
		ChestGenHooks.getInfo(BUTCHER_CHEST).setMin(6);
	}
	public static final String BAKERY_CHEST = "bakeryChest";
	public static final String BUTCHER_CHEST = "butcherChest";
