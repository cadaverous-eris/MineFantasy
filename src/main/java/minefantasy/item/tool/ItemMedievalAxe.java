 ...
 */
public class ItemMedievalAxe extends ItemAxe implements IPublicMaterialItem, IWeaponSpecial, IBattlegearWeapon {
	...
	public boolean onBlockDestroyed(ItemStack item, World world, int id, int x, int y, int z, EntityLivingBase user) {
		...
		if (world.getBlockMaterial(x, y, z) == Material.wood && getMaterial() == ToolMaterialMedieval.DRAGONFORGE
				&& rand.nextInt(12) == 0) {
