...
public class TileEntityRoastRenderer extends TileEntitySpecialRenderer {
	...
	private float getRotationForItem(Item item) {
		...
		if (classname.endsWith("ItemSpade") || classname.endsWith("ItemCrossbow")
				|| classname.endsWith("ItemBlunderbuss") || classname.endsWith("ItemBlowgun")
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
		renderAModelAt((TileEntityRoast) tileentity, d, d1, d2, f); // where to
																	// render
	}
