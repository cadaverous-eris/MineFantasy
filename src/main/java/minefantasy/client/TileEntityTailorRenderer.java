...
public class TileEntityTailorRenderer extends TileEntitySpecialRenderer {
	...
	public void renderAModelAt(TileEntityTailor tile, double d, double d1, double d2, float f) {
		...
		GL11.glScalef(1.0F, -1.0F, -1.0F); // if you read this comment out this
											// line and you can see what happens
		...
		try {
			...
			if (cfg.renderWarnings) {
				Minecraft.getMinecraft().thePlayer.addChatMessage("Don't put that on the tailor bench");
			}
		}
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f) {
		renderAModelAt((TileEntityTailor) tileentity, d, d1, d2, f); // where to
																		// render
	}
