...
public class MFProxy_client extends MFProxy_common
{
	...
	public void registerVillagerSkins() {
		VillagerRegistry.instance().registerVillagerSkin(77, new ResourceLocation("minefantasy", "textures/mob/villager/tailor.png"));
		VillagerRegistry.instance().registerVillagerSkin(78, new ResourceLocation("minefantasy", "textures/mob/villager/baker.png"));
	}
	...
	private void registerItemRenderer()
	{
		...
		MinecraftForgeClient.registerItemRenderer(ItemListMF.bucklerIgnotumite.itemID, new RenderShield());
		...
		MinecraftForgeClient.registerItemRenderer(ItemListMF.kiteIgnotumite.itemID, new RenderShield());
		...
		MinecraftForgeClient.registerItemRenderer(ItemListMF.towerIgnotumite.itemID, new RenderShield());
